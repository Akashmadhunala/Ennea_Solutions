    ...
    return (
        <nav className="navbar navbar-expand-lg bg-body-tertiary">
            <div className="container-fluid" style={{ width: "95%" }}>
                <NavLink className="navbar-brand" to="/" style={{ fontWeight: "bold" }}>All Courses</NavLink>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    {userId ?
                        ...
                        <ul className="navbar-nav me-end mb-2 mb-lg-0">
                            <li className="nav-item">
                                <NavLink className="nav-link active" aria-current="page" to={`/login`} style={{ backgroundColor: '#007BFF', color: '#fff', fontWeight: '600', width: '80px', textAlign: 'center', borderRadius: '20px', padding: '5px' }}>Sign In</NavLink>
                            </li>
                        </ul>}
                </div>
            </div>
